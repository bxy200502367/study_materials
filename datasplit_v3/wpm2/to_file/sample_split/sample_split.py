...
def export_sample_split_info(data, option_name, dir_path, bind_obj=None):
    ...
    with open(specimen_info_list, "w") as w:
        ...
        for doc in sg_split_docs:
            ...
            library_work_path = doc.get("work_path", "")
            ...
            for specimen_doc in sg_split_specimen_docs:
                ...
                if meta_type == "official":
                    ...
                    barcode_tag = barcode_doc["barcode_tag"] # 带随机碱基的信息
                ...
                if not specimen_doc.get("split_method"):
                    split_method = "Pair"
                else:
                    split_method = specimen_doc.get("split_method")
                if not specimen_doc.get("is_its_primer"):
                    is_its_primer = "no"
                else:
                    is_its_primer = specimen_doc.get("is_its_primer")
