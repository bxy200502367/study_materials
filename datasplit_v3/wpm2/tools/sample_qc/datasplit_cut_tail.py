...
DatasplitCutTailAgent = type(
    "DatasplitCutTailAgent", (Agent, ),
    create_agent_dict_by_yaml(read_local_file(__file__, "datasplit_cut_tail.yml")))
DatasplitCutTailTool = type(
    "DatasplitCutLeftTool", (Tool, ),
    create_tool_dict_by_yaml(read_local_file(__file__, "datasplit_cut_tail.yml"),
