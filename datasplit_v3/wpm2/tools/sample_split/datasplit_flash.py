...
DatasplitFlashAgent = type(
    "DatasplitFlashAgent", (Agent, ),
    create_agent_dict_by_yaml(read_local_file(__file__, "datasplit_flash.yml")))
DatasplitFlashTool = type(
    "DatasplitFlashTool", (Tool, ),
    create_tool_dict_by_yaml(read_local_file(__file__, "datasplit_flash.yml"),
