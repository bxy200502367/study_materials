...
SampleRenameAgent = type(
    "SampleRenameAgent", (Agent, ),
    create_agent_dict_by_yaml(read_local_file(__file__, "sample_rename.yml")))

SampleRenameTool = type(
    "SampleRenameTool", (Tool, ),
    create_tool_dict_by_yaml(read_local_file(__file__, "sample_rename.yml"),
