...
ResultArrangeAgent = type(
    "ResultArrangeAgent", (Agent, ),
    create_agent_dict_by_yaml(read_local_file(__file__, "result_arrange.yml")))

ResultArrangeTool = type(
    "ResultArrangeTool", (Tool, ),
    create_tool_dict_by_yaml(read_local_file(__file__, "result_arrange.yml"),
