...
DatasplitMd5sumAgent = type(
    "DatasplitMd5sumAgent", (Agent, ),
    create_agent_dict_by_yaml(read_local_file(__file__, "datasplit_md5sum.yml")))
DatasplitMd5sumTool = type(
    "DatasplitMd5sumTool", (Tool, ),
    create_tool_dict_by_yaml(read_local_file(__file__, "datasplit_md5sum.yml"),
