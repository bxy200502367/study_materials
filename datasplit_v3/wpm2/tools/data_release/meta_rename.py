...
MetaRenameAgent = type(
    "MetaRenameAgent", (Agent, ),
    create_agent_dict_by_yaml(read_local_file(__file__, "meta_rename.yml")))

MetaRenameTool = type(
    "MetaRenameTool", (Tool, ),
    create_tool_dict_by_yaml(read_local_file(__file__, "meta_rename.yml"),
