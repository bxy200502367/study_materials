...
def get_barcode_config(infile: str, outfile: str) -> None:
    """
    获取barcode配置信息
    """
    with open(infile, "r") as f, open(outfile, "w") as w:
        header_list = ["#Sample", "Barcode-tag", "Fbarcode", "Rbarcode"]
        ...
        for row in f_csv:
            ...
            new_line_list = [sample_id, each_row.barcode_tag, each_row.f_barcode, each_row.r_barcode]
...
if __name__ == "__main__":
    ...
    get_barcode_config(args.infile, args.outfile)
