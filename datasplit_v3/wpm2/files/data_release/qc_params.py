...
class QcParamsFile(File):
    ...
    """
    def __init__(self):
        super(QcParamsFile, self).__init__()

    def check(self):
        if super(QcParamsFile, self).check():
    ...
    def dump_json(self):
        ...
        try:
            ...
            if json_dict:
                ...
                self.set_property("cut_window_size", json_dict["fastp"].get("cut_window_size", "4"))
            else:
                ...
                self.set_property("cut_window_size", None)
        except:
