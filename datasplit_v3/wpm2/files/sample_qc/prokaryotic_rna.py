...
class ProkaryoticRnaParamsFile(File):
    """
    name: prokaryotic_rna_params
    Description: |
        prokaryotic_rna质控参数File类
    """
    def __init__(self):
        super(ProkaryoticRnaParamsFile, self).__init__()

    def check(self):
        if super(ProkaryoticRnaParamsFile, self).check():
