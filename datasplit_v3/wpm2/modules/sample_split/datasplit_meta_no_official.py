...
def is_single(self):
    if self.option("split_type") == "Auto" and self.option("meta_no_official_info").prop["split_method"] == "Single":
        return True
...
def is_pair(self):
    if self.option("split_type") == "Auto" and self.option("meta_no_official_info").prop["split_method"] == "Pair":
        return True
    elif self.option("split_type") == "Pair":
        return True
    else: 
