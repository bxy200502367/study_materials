...
DatasplitMetaOfficialPairModule = type(
    "DatasplitMetaOfficialPairModule", (Module, ),
    create_module_dict_by_yaml(read_local_file(__file__, "datasplit_meta_official_pair.yml")))